...
add wave -noupdate -expand -group keys /aes_engine_top_tb/dut/i_key
add wave -noupdate -expand -group keys /aes_engine_top_tb/dut/i_key_192
add wave -noupdate -expand -group keys /aes_engine_top_tb/dut/i_key_256
...
add wave -noupdate -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/wea
add wave -noupdate -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/addra
add wave -noupdate -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/dina
add wave -noupdate -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/douta
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {172995 ps} 0}
...
update
WaveRestoreZoom {0 ps} {3366576 ps}
