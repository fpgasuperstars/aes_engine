...
add wave -noupdate /aes_engine_top_tb/dut/dec_expanded_key_lo
add wave -noupdate /aes_engine_top_tb/dut/dec_expanded_key_lo_q
add wave -noupdate /aes_engine_top_tb/dut/last_rnd_dec_lo
add wave -noupdate -radix decimal /aes_engine_top_tb/dut/lo_spd_cnt_dec
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {421158 ps} 0}
...
update
WaveRestoreZoom {263917 ps} {482041 ps}
