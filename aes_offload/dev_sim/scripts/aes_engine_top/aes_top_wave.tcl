...
add wave -noupdate -group {internal values} /aes_engine_top_tb/dut/rnd_cipher_txt
...
add wave -noupdate -group {control and status} /aes_engine_top_tb/dut/config_data
...
WaveRestoreCursors {{Cursor 1} {7575959 ps} 0}
