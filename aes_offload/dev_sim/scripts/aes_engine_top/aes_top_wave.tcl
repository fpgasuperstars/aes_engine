...
add wave -noupdate -group FIFO -expand -group fifo -radix hexadecimal /aes_engine_top_tb/u_fifo/s_axis_tkeep
...
add wave -noupdate -group FIFO -expand -group master -radix hexadecimal /aes_engine_top_tb/u_fifo/m_axis_tkeep
...
WaveRestoreCursors {{Cursor 1} {19519355133 fs} 0} {{Cursor 2} {93917752 fs} 0} {{Cursor 3} {495000000 fs} 0} {{Cursor 4} {105437663 fs} 0} {{Cursor 5} {374570990 fs} 0} {{Cursor 6} {705000000 fs} 0}
...
update
WaveRestoreZoom {0 fs} {1405687500 fs}
