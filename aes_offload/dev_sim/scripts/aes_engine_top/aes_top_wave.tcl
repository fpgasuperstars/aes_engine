...
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axi stream in} -radix hexadecimal /aes_engine_top_tb/dut/i_t_data
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axi stream in} /aes_engine_top_tb/dut/i_t_valid
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axi stream in} /aes_engine_top_tb/dut/i_t_last
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axi stream in} -radix hexadecimal /aes_engine_top_tb/dut/i_t_keep
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axis out} -radix hexadecimal /aes_engine_top_tb/dut/o_t_data
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axis out} /aes_engine_top_tb/dut/o_t_valid
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axis out} /aes_engine_top_tb/dut/o_t_last
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axis out} -radix hexadecimal /aes_engine_top_tb/dut/o_t_keep
add wave -noupdate -expand -group {AES Engine} -expand -group IO -expand -group {axis out} /aes_engine_top_tb/dut/o_t_ready
...
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} /aes_engine_top_tb/dut/speed_en
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -radix unsigned /aes_engine_top_tb/dut/duty_cycle_cnt
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -radix unsigned /aes_engine_top_tb/dut/en_cnt
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} /aes_engine_top_tb/dut/new_key
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -radix unsigned /aes_engine_top_tb/dut/flushout_cnt
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} /aes_engine_top_tb/dut/state
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -radix hexadecimal /aes_engine_top_tb/dut/key_handle_q
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -expand -group configuration /aes_engine_top_tb/dut/mode
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -expand -group configuration -radix hexadecimal /aes_engine_top_tb/dut/iv
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -expand -group configuration /aes_engine_top_tb/dut/aes_mode
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} -expand -group configuration /aes_engine_top_tb/dut/en_decr
add wave -noupdate -expand -group {AES Engine} -expand -group {control and status} /aes_engine_top_tb/dut/o_done
add wave -noupdate -expand -group {AES Engine} -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/clka
add wave -noupdate -expand -group {AES Engine} -expand -group BRAM /aes_engine_top_tb/dut/u_bram_keys/ena
add wave -noupdate -expand -group {AES Engine} -expand -group BRAM -radix unsigned /aes_engine_top_tb/dut/u_bram_keys/addra
add wave -noupdate -expand -group {AES Engine} -expand -group BRAM -radix hexadecimal /aes_engine_top_tb/dut/u_bram_keys/douta
add wave -noupdate -expand -group {AES Engine} -expand -group BRAM -radix unsigned /aes_engine_top_tb/dut/i_key_handle
...
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/ghash_tag
add wave -noupdate /aes_engine_top_tb/dut/ghash_u/i_clk
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/i_ghash_text
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/i_h
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/i_j0
add wave -noupdate /aes_engine_top_tb/dut/ghash_u/i_rst
add wave -noupdate /aes_engine_top_tb/dut/ghash_u/i_tag_done
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/o_ghash_tag
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/x
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/y
add wave -noupdate -radix hexadecimal /aes_engine_top_tb/dut/ghash_u/y_q
add wave -noupdate /aes_engine_top_tb/dut/aad_done
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {19519355133 fs} 0} {{Cursor 2} {597444532 fs} 0} {{Cursor 3} {1590000000 fs} 0} {{Cursor 4} {140470228 fs} 0} {{Cursor 5} {4732979607 fs} 0} {{Cursor 6} {32126601446 fs} 0}
...
update
WaveRestoreZoom {551607292 fs} {902701042 fs}
